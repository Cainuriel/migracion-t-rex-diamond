...
export interface ITrustedIssuersEventsInterface extends Interface {
  getEvent(
...
export interface ITrustedIssuersEvents extends BaseContract {
  connect(runner?: ContractRunner | null): ITrustedIssuersEvents;
  waitForDeployment(): Promise<this>;

  interface: ITrustedIssuersEventsInterface;
