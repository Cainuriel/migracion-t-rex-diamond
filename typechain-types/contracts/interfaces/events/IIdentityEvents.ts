...
export interface IIdentityEventsInterface extends Interface {
  getEvent(
...
export interface IIdentityEvents extends BaseContract {
  connect(runner?: ContractRunner | null): IIdentityEvents;
  waitForDeployment(): Promise<this>;

  interface: IIdentityEventsInterface;
