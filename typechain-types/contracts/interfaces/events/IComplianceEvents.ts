...
export interface IComplianceEventsInterface extends Interface {
  getEvent(
...
export interface IComplianceEvents extends BaseContract {
  connect(runner?: ContractRunner | null): IComplianceEvents;
  waitForDeployment(): Promise<this>;

  interface: IComplianceEventsInterface;
