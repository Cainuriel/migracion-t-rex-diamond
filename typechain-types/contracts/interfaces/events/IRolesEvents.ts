...
export interface IRolesEventsInterface extends Interface {
  getEvent(
...
export interface IRolesEvents extends BaseContract {
  connect(runner?: ContractRunner | null): IRolesEvents;
  waitForDeployment(): Promise<this>;

  interface: IRolesEventsInterface;
