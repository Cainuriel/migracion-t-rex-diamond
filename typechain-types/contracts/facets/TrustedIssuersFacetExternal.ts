...
export interface TrustedIssuersFacetExternalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addTrustedIssuer"
      | "getTrustedIssuers"
...
export interface TrustedIssuersFacetExternal extends BaseContract {
  connect(runner?: ContractRunner | null): TrustedIssuersFacetExternal;
  waitForDeployment(): Promise<this>;

  interface: TrustedIssuersFacetExternalInterface;
