...
export interface RolesFacetExternalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "initializeRoles"
      | "isAgent"
...
export interface RolesFacetExternal extends BaseContract {
  connect(runner?: ContractRunner | null): RolesFacetExternal;
  waitForDeployment(): Promise<this>;

  interface: RolesFacetExternalInterface;
