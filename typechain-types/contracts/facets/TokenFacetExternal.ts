...
export interface TokenFacetExternalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface TokenFacetExternal extends BaseContract {
  connect(runner?: ContractRunner | null): TokenFacetExternal;
  waitForDeployment(): Promise<this>;

  interface: TokenFacetExternalInterface;
