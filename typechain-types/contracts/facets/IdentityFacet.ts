...
export interface IdentityFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "deleteIdentity"
      | "getIdentity"
...
export interface IdentityFacet extends BaseContract {
  connect(runner?: ContractRunner | null): IdentityFacet;
  waitForDeployment(): Promise<this>;

  interface: IdentityFacetInterface;
