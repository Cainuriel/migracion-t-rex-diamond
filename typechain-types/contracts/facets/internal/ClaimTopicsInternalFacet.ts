...
export interface ClaimTopicsInternalFacetInterface extends Interface {
  getEvent(
...
export interface ClaimTopicsInternalFacet extends BaseContract {
  connect(runner?: ContractRunner | null): ClaimTopicsInternalFacet;
  waitForDeployment(): Promise<this>;

  interface: ClaimTopicsInternalFacetInterface;
