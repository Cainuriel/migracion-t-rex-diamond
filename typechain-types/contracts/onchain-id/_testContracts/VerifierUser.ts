...
export interface VerifierUserInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addClaimTopic"
      | "addTrustedIssuer"
...
export interface VerifierUser extends BaseContract {
  connect(runner?: ContractRunner | null): VerifierUser;
  ...
  doSomething: TypedContractMethod<[], [void], "nonpayable">;
